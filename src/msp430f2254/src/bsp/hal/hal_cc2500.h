//----------------------------------------------------------------------------
//  Description:  CC2500.c function declarations
//
...
extern uint8_t* cc_spiAdd;

//****************** CC2500 General Configuration Definition *******************

#define TI_CC_BR_250_KBPS       250
#define TI_CC_BR_10_KBPS        10

#define TI_CC_BAUD_RATE_KBPS    TI_CC_BR_10_KBPS     

#define FRQ_FACTOR				16
#define TI_CC_TX_TIMEOUT		10000
...
uint8_t hal_cc2500_sendPacket(uint8_t addr, uint8_t *txBuffer, uint8_t size);
uint8_t hal_cc2500_receivePacket(uint8_t *addr, uint8_t *rxBuffer, uint8_t *length, uint8_t *rssi, uint8_t *lqi);
...
int16_t _cc2500_rssiDecToDbm(uint8_t rssiDec);
...
#define TI_CCxxx0_NUM_TXBYTES  0x7F        // Mask "# of bytes" field in _TXBYTES
...
//State
#define TI_CCxxx0_STATUS_STATE 	0x70
#define TI_CCxxx0_STATUS_TX    	0x20
#define TI_CCxxx0_STATUS_FSTXON	0x30

#if TI_CC_BAUD_RATE_KBPS == TI_CC_BR_10_KBPS

#define TI_CC25000_RSSI_OFFSET 	69

#elif TI_CC_BAUD_RATE_KBPS == TI_CC_BR_250_KBPS

#define TI_CC25000_RSSI_OFFSET 	72
